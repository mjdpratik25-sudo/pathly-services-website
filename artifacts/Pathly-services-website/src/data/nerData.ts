...
export const NER_DISTRICTS: NERDistrict[] = [
  ...
  { id: 'ML-WJH', name: 'West Jaintia Hills', state: 'Meghalaya', lat: 25.4500, lng: 92.2000, elevation: 1380, terrain: 'hills', population: 270352, area: 1693, connectivityScore: 62, connectivityStatus: 'moderate', majorTown: 'Jowai', nhConnected: ['NH-44', 'NH-6'], railConnected: false, airportNearby: false, floodRisk: 'low', landslideRisk: 'medium', avgRainfall: 3500 },
  // Tripura
  ...
  { id: 'MN-TEN', name: 'Tengnoupal', state: 'Manipur', lat: 24.2500, lng: 94.3000, elevation: 850, terrain: 'mountains', population: 64812, area: 1200, connectivityScore: 35, connectivityStatus: 'poor', majorTown: 'Moreh', nhConnected: ['NH-2', 'AH-1'], railConnected: false, airportNearby: false, floodRisk: 'medium', landslideRisk: 'high', avgRainfall: 1900 },
...
export const ROAD_SEGMENTS: RoadSegment[] = [
  ...
  { id: 'NH44-SHI-JOW', name: 'NH-44 Shillong–Jowai', type: 'NH', from: 'Shillong', to: 'Jowai', fromLat: 25.5788, fromLng: 91.8933, toLat: 25.4500, toLng: 92.2000, distance: 64, status: 'open', condition: 76, lastUpdated: '1 hour ago', riskScore: 28, terrain: 'hills', altitude: 1380, bridgeCount: 4, trafficCongestion: 'fluent', avgSpeedKmH: 48, delayMinutes: 5, laneCount: 2, pavementType: 'Paved Hill Highway (NH-44)' },
  { id: 'NH2-IMP-MOR-DIR', name: 'NH-2 Imphal–Moreh Direct', type: 'NH', from: 'Imphal', to: 'Moreh', fromLat: 24.8170, fromLng: 93.9368, toLat: 24.2500, toLng: 94.3000, distance: 108, status: 'blocked', condition: 18, lastUpdated: '35 mins ago', riskScore: 94, terrain: 'mountains', altitude: 950, bridgeCount: 9, trafficCongestion: 'jammed', avgSpeedKmH: 0, delayMinutes: 180, laneCount: 2, pavementType: 'Hill Pass (Full Landslide Blockade on NH-2)' },
  { id: 'SH-IMP-KAK-MOR', name: 'MDR Imphal–Thoubal–Kakching–Moreh Bypass', type: 'SH', from: 'Imphal', to: 'Moreh', fromLat: 24.8170, fromLng: 93.9368, toLat: 24.2500, toLng: 94.3000, distance: 126, status: 'open', condition: 65, lastUpdated: '40 mins ago', riskScore: 42, terrain: 'hills', altitude: 820, bridgeCount: 7, trafficCongestion: 'moderate', avgSpeedKmH: 36, delayMinutes: 20, laneCount: 2, pavementType: 'State Highway Bypass (Avoids NH-2 Landslide)' }
];
...
export const VEHICLES: Vehicle[] = [
  ...
  { id: 'NER-V002', orderToken: 'ORD-ML-33087', registrationNo: 'ML-05-C-5678', type: 'mini_truck', driverName: 'Bah Kynjah Lyngdoh', driverPhone: '9436234567', cargoType: 'food_supplies', cargoDescription: 'Rice, pulses, cooking oil & PDS supplies for Jowai / Jaintia distribution centers', cargoWeight: 2.8, origin: 'Shillong', destination: 'Jowai', currentLat: 25.52, currentLng: 91.95, speed: 38, heading: 110, status: 'in_transit', eta: '1h 15min', departureTime: '08:00 AM', route: 'NH-44', progress: 45, fuelLevel: 68, priority: 'normal' },
  ...
  { id: 'NER-V004', orderToken: 'ORD-MN-51190', registrationNo: 'MN-01-E-3456', type: 'ambulance', driverName: 'Thingbaijam Ibochouba', driverPhone: '8794556677', cargoType: 'agricultural', cargoDescription: 'High-value organic seeds, bamboo produce & spices for border trade terminal (Bypasses NH-2 blockage)', cargoWeight: 3.5, origin: 'Imphal', destination: 'Moreh', currentLat: 24.62, currentLng: 94.01, speed: 34, heading: 155, status: 'in_transit', eta: '3h 10min', departureTime: '07:15 AM', route: 'MDR Kakching Bypass (NH-2 Blocked)', progress: 38, fuelLevel: 75, priority: 'normal' },
  ...
  { id: 'NER-V006', orderToken: 'ORD-MZ-14456', registrationNo: 'MZ-01-G-2345', type: 'mini_truck', driverName: 'Lalchhuanawma Ralte', driverPhone: '9436889900', cargoType: 'fuel', cargoDescription: 'Diesel fuel and essential energy supplies for Lunglei district generators', cargoWeight: 8.0, origin: 'Aizawl', destination: 'Lunglei', currentLat: 23.20, currentLng: 92.73, speed: 25, heading: 190, status: 'delayed', eta: '6h 00min', departureTime: '06:00 AM', route: 'NH-54', progress: 28, fuelLevel: 45, priority: 'high' },
